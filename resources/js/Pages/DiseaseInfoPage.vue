...
const isProfileAvailable = computed(() => {
    return Object.keys(diseaseProfile.value || {}).length > 0;
});
...
<template>
    ...
    <div class="form-container">
        ...
        <div v-else class="no-profile">
            <p style="text-align: center;" class="mt-10">No available disease profile for this patient.</p>
            <div class="flex items-center justify-center mt-4 mb-4">
                <PrimaryButton class="mt-4" @click="goToDisease">
                    Add Disease Profile
                </PrimaryButton>
            </div>
        </div>
