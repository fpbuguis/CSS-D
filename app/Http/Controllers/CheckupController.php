...
{
    /**
     * Fetch the latest checkup by patient ID.
     * 
     * @param int $id
     * 
     */
    ...
    public function createCheckup(Request $request)
    {
        ...
        // Check if the disease profile exists for the patient.
        ...
        //Determine checkup status based on the confirmed date.
