...
class PatientController extends Controller
{
    ...
    public function store(Request $input)
    {
        ...
        // Check if a user with the same full name and birthdate already exists
        $duplicateUser = User::where([
        ...
        if ($duplicateUser) {
            throw \Illuminate\Validation\ValidationException::withMessages([
                'duplicate' => 'A user with the same full name and birthdate already exists.',
            ]);
        }
